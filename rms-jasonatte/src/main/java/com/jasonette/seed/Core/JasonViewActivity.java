...
public class JasonViewActivity extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback, TemiSpeakListener {
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JasonComponentFactory.addListener(this);
    ...
    @Override
    public void onSpeakTextFound(final String text) {
        Timber.d(text);
        string = text;
        AsyncTask.execute(new Runnable() {
            @Override
            public void run() {
                if(recentSpokenText == null){
                    recentSpokenText = string;
                }
            }
        });
    }
